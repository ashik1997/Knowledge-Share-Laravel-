            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>@if ($blog->status==0)<a class="btn btn-primary" href="{{ url('/admin/approved-blog',$blog->id) }}">approved</a>||@endif<a class="btn btn-danger" href="{{ url('/admin/delete-blog',$blog->id) }}">delete</a></td>
                </tr>
                <?php $sl++; ?>
                @endforeach
                </tbody>
