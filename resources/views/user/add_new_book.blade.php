        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-body pad">
              <div class="col-md-12">
                @if(Session::has('add_book_flash_error'))
                <div class="alert alert-danger alert-dismissible fade in"  id="myAlert">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>{!! session('add_book_flash_error') !!} !</strong>
                </div>
                @endif
                @if(Session::has('add_book_flash_success'))
                <div class="alert alert-success alert-dismissible fade in"  id="myAlert">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>{!! session('add_book_flash_success') !!} !</strong>
                </div>
                @endif
                @if ($errors->any())
              ...
              <form method="POST" action="{{ url('/user/add-book') }}" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="form-group">
                        <label>Image1 (Max file size:2024 kb, Max_width=350,max_height=450)</label>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="form-group">
                        <label>Image3 (Max file size:2024 kb)</label>
                ...
                <input type="submit" name="book_post" class="btn btn-primary btn-lg" value="POST">
