...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Add new audio</li>
    </ol>
  </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-body pad">
              <div class="col-md-12">
                @if(Session::has('add_audio_flash_error'))
                <div class="alert alert-danger alert-dismissible fade in"  id="myAlert">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>{!! session('add_audio_flash_error') !!} !</strong>
                </div>
                @endif
                @if(Session::has('add_audio_flash_success'))
                <div class="alert alert-success alert-dismissible fade in"  id="myAlert">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>{!! session('add_audio_flash_success') !!} !</strong>
                </div>
                @endif
                @if ($errors->any())
              ...
              <form method="POST" action="{{ url('/user/add-audio') }}" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                  <div class="col-md-6">
                ...
                <input type="submit" name="audio_post" class="btn btn-primary btn-lg" value="POST">
              </form>
            </div>
          </div>
        </div>
