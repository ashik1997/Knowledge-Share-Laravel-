        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Own post by audios</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="col-md-12">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>@if ($audio->status==0)
                    <a class="btn btn-success">please waiting for approval</a>||
                  @endif<a class="btn btn-primary" href="{{ url('/user/edit-audio',$audio->id) }}">edit</a>||<a class="btn btn-danger" href="{{ url('/user/delete-audio',$audio->id) }}">delete</a></td>
                </tr>
                <?php $sl++; ?>
                @endforeach
                </tbody>
